You only have to edit config.json!

Use this file to configure your:
- database login credentials
- each camera's details and their tables ROI points

(Be sure that you follow the format of the JSON file!)

To get the ROI points of a table:
- run "get_roi_points.py"
